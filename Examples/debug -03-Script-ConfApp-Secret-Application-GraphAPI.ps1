...
$var = Invoke-RestMethod -Method get -Headers $Headers -Uri "https://graph.microsoft.com/beta/users/$UserObjectId/authentication/methods" | select -ExpandProperty value

#Azure will reply this

<#
PS C:\Users\francois.leon> $var.value
